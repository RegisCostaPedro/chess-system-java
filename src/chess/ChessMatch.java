...
public class ChessMatch {
    ...
    private List<Piece> caputuredPieces = new ArrayList<>();
    public ChessMatch(){
        board = new Board(8,8);
        turn = 1;
    ...
    public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPostion){
        ...
        Position target = targetPostion.toPostion();
    ...
    private Piece makeMove(Position source, Position target){
        ...
        if (capturedPiece != null){
            ...
            caputuredPieces.add(capturedPiece);
        }
    ...
    private void undoMove(Position source, Position target, Piece capturedPiece){
        ...
        if (capturedPiece != null){
            ...
            caputuredPieces.remove(capturedPiece);
